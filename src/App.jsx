...
function App() {
  ...
  const exportClosingCosts = () => {
    ...
    // Subtitle
    addText('Marisol Gallegos | Realtor®', pageWidth / 2, yPosition, {
      fontSize: 12,
      color: grayColor,
      align: 'center'
    })
    ...
    addText('Generated by Marisol Gallegos - Home Buyer Consultation', pageWidth / 2, yPosition, {
      fontSize: 9,
      color: grayColor,
      align: 'center'
    })
    ...
    <div className="landing-page">
        ...
        <div className="hero-content">
          <div className="hero-layout">
            <div className="hero-text-column">
              ...
              <p className="hero-subtitle">Buying | Selling | New Construction Expert</p>
              <p className="hero-location">Serving Dallas, Frisco, Plano & DFW Metroplex</p>
      ...
      <section className="marquee-section">
        <div className="marquee-container">
          <div className="marquee-content">
            <span className="marquee-item">Top 10 Realtor on Social Media</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">8+ Years of Real Estate Excellence</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">5.0 Perfect Client Rating</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">DFW Area Expert • Dallas • Frisco • Plano</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">29 Recent Sales • $140K - $600K Price Range</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Licensed Texas Realtor • eXp Realty</span>
            <span className="marquee-dot">•</span>
            ...
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Serving All of DFW Metroplex</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Top 10 Realtor on Social Media</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">8+ Years of Real Estate Excellence</span>
      ...
      <section id="areas-served" className="areas-served fade-in-section">
        <div className="container">
          <h2 className="section-title">Areas We Serve in the DFW Area</h2>
          <p className="section-subtitle">Licensed in Texas - serving the entire Dallas-Fort Worth Metroplex</p>
          <div className="locations-grid">
            <div className="location-card">
              <h3 className="location-title">Dallas & Surrounding Areas</h3>
              <ul className="location-list">
                ...
                <li>Lancaster</li>
                <li>Cedar Hill</li>
                <li>And all Dallas County areas</li>
              </ul>
            </div>
            <div className="location-card">
              <h3 className="location-title">Frisco, Plano & North Dallas</h3>
              <ul className="location-list">
                <li>Frisco</li>
                <li>Plano</li>
                <li>McKinney</li>
                ...
                <li>Carrollton</li>
                <li>Lewisville</li>
                <li>And all Collin County areas</li>
              </ul>
            </div>
            <div className="location-card">
              <h3 className="location-title">Celina, Prosper & More</h3>
              <ul className="location-list">
                <li>Celina</li>
                <li>Prosper</li>
                <li>Aubrey</li>
                ...
                <li>And surrounding DFW communities</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-info">
              <p className="footer-name">Marisol Gallegos | Realtor®</p>
              <p className="footer-license">Dallas, Frisco, Plano, Texas</p>
              <div className="footer-contact">
                <a href="mailto:marisol@example.com" className="footer-email">marisol@example.com</a>
                <a href="tel:9036036903" className="footer-phone">(903) 603-6903</a>
              </div>
            </div>
